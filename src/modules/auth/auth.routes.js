...
import { changeMyPasswordSchema, forgotPasswordSchema, resetPasswordSchema, signInOutSchema, verifyRessetCodeSchema } from "./auth.validator.js";
const authRouter = express.Router();

authRouter.post("/signup",validation(createUserSchema),authController.signUp);
authRouter.post("/logout",validation(signInOutSchema),authController.logOut);
...
authRouter.put('/changeMyPassword',validation(changeMyPasswordSchema),authController.changeMyPassword);
authRouter.put('/resetPassword',validation(resetPasswordSchema),authController.ressetPassword);
